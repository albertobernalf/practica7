...
class Ingresos(models.Model):
    ...
    especialidadesMedicosIngreso =  models.ForeignKey('clinico.EspecialidadesMedicos', default=1, on_delete=models.PROTECT, null=True,  related_name='EspIng')
    ...
    especialidadesMedicosActual = models.ForeignKey('clinico.EspecialidadesMedicos', default=1, on_delete=models.PROTECT,
   ...
   # serviciosSalida  = models.ForeignKey('clinico.Servicios', default=1, on_delete=models.PROTECT, null=True,  related_name='id11')
    ...
    especialidadesMedicosSalida = models.ForeignKey('clinico.EspecialidadesMedicos', default=1, on_delete=models.PROTECT,
